...
// let strArr = testStringArr.split(/[,.?!']/)
...
// let search = /\b\d{1,2}\/\d{1,2}\/\d{4}\b/g
// let res = testString.match(search)
// console.log(res);

// Задача 10. Дано рядок тексту. Підрахувати кількість двоцифрових чисел у рядку.

// let testString = '11 aaa11 2b ccc 22'
// let arr = testString.match(/\b\d{2}\b/g).length
// console.log(arr);
...
//     let number = parseInt(testString)
//     if (number === 1 || number === 4)
//         console.log('робоий день');
//     else
//         console.log('вихідний');
// } else if (testString.match(/^(sun|mon|tue|wed|thu|fri|sat)$/i)) {
//     let day = testString.toLowerCase()
//     if (day === 'sat' || day === 'sun')
//         console.log('вихідний');
//     else
//         console.log('робоий день');
